...
MatrixInteractions.prototype.CONST = {
	...
	ICONS : {
		PROMOTIONS : "fa fa-check-circle",
		NO_PROMOTIONS : "fa fa-check",
		DEMOTIONS : "fa fa-times-circle",
		NO_DEMOTIONS : "fa fa-times",
		VISIBILITY : "fa fa-eye",
		ORDERING : "fa fa-sort", //"icon-sort-by-attributes-alt",
		SELECTION : "fa fa-tag",
		PRIORITY : "fa fa-signal" //"icon-sort-by-attributes-alt"
	}
};
